 ...
 * Module dependencies.
 */
var header = config.restUrl.contentType,
    restService = require('./rest-client/service'),
    restUrls = require('./rest-client/urls'),
    log = logger.logger("campaign-service");

exports.getCampaignById = function(id, callback) {
    callback({
        "responseCode": 0,
...
exports.getSamplePoolEntries = function(campaignId, offset, limit, poolName, callback) {
    var headers = header;
    var params = {
    ...
    restService.builbArgs(restUrls.campaign.simplepoolentries, params, headers, function(args) {
